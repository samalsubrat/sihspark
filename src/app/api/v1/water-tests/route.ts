...
function hasCompleteQualityData(quality: WaterTestPayload['quality']): boolean {
  const requiredFields = ['ph', 'turbidity', 'conductivity', 'hardness', 'chloramines', 'sulfate', 'solids', 'organic_carbon', 'trihalomethanes']
  return requiredFields.every(field => 
    quality && quality[field as keyof typeof quality] !== undefined && 
    quality[field as keyof typeof quality] !== null && 
    !isNaN(Number(quality[field as keyof typeof quality]))
  )
}
